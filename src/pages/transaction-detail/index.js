  ...
  return (
    <div>
      ...
      <div className="xl:p-20 lg:p-16 sm:p-10 p-4">
        <section className="pt-20 md:pb-20 pb-10">
          <h1 className="font-jakarta lg:text-4xl md:text-3xl text-2xl font-semibold text-center">TRANSACTION DETAIL</h1>
        </section>
        ...
        <section>
          ...
          <div className="sm:flex sm:justify-between sm:items-center sm:pb-20 pb-14 sm:px-5">
            <div className="lg:w-3/5 sm:w-1/2 sm:block flex justify-between">
              <h5 className="font-jakarta lg:text-base md:text-sm text-xs font-bold">Status</h5>
              <p className="font-lato lg:text-base md:text-sm text-xs font-normal inline px-1 bg-[#F3EB30] rounded-[10px]">On Progress</p>
            </div>
