export default function BoardTotal() {
  return (
    <>
      <div className="grid grid-cols-4 gap-2 px-3 py-4 midget:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 xl:grid-cols-4 h-full">
        <div>
          <h1 className="text-xl font-bold">Board Total</h1>
        </div>
        <div>
          {/* Column 1 */}
